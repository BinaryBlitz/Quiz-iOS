...
- (void)updateTopcs:(NSDictionary *)topicsInRequest
         inCategory:(QZBCategory *)category {
...
- (void)PATCHSessionQuestionWithID:(NSInteger)sessionQuestionID
  ...
  NSDictionary *params = @{
    @"game_session_question" :
        @{@"answer_id" : @(answerID), @"time" : @(answerTime)},
    @"token" : [QZBCurrentUser sharedInstance].user.api_key
  };
...
- (void)GETPlayerWithID:(NSNumber *)playerID
  ...
  [self.requestOperationManager GET:urlString
      ...
      success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        QZBAnotherUser *user =
            [[QZBAnotherUser alloc] initWithDictionary:responseObject];
  ...
  [self.requestOperationManager GET:@"friendships/requests"
      ...
      success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        for (NSDictionary *dict in responseObject) {
          QZBAnotherUser *user =
              [[QZBAnotherUser alloc] initWithDictionary:dict];
...
- (void)PATCHMarkRequestsAsViewedOnSuccess:
            (void (^)())success onFailure:
                (void (^)(NSError *error, NSInteger statusCode))failure {
  NSDictionary *params = @{
    @"token" : [QZBCurrentUser sharedInstance].user.api_key
  };
...
- (void)GETAllFriendsOfUserWithID:(NSNumber *)userID
  ...
  NSString *urlString =
      [NSString stringWithFormat:@"/players/%@/friends", userID];
...
- (void)GETRankingWeekly:(BOOL)isWeekly
  ...
  NSMutableString *urlAsString =
      [NSMutableString stringWithString:@"/rankings/"];
  if (isWeekly) {
  ...
  [self.requestOperationManager GET:urlAsString
      ...
      success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        [self parseRatingDict:responseObject
                   toTopArray:usersTop
                 playerRating:usersPlayer];
...
- (void)GETAvailableInAppPurchasesOnSuccess:
            (void (^)(NSArray *purchases))success
                                  onFailure:
                                      (void (^)(NSError *error,
                                                NSInteger statusCode))failure {
